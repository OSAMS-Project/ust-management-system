...
const createBorrowLogsTable = async () => {
	const query = `
...
const createBorrowLog = async (logData) => {
	const query = `
...
const getBorrowLogsByAssetId = async (assetId) => {
	const query = `
...
const updateBorrowLogReturnDate = async (borrowingRequestId, dateReturned) => {
	const query = `
      UPDATE borrow_logs
      SET date_returned = $1
...
module.exports = {
	...
	createBorrowLog,
	getBorrowLogsByAssetId,
	updateBorrowLogReturnDate,
};
