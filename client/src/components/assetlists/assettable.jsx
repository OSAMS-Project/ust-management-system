					...
					<thead>
						<tr className="bg-black text-[#FEC00F]">
							...
							{visibleColumns.dateCreated && (
								<th className="text-center py-3 px-4">Date Created</th>
							)}
							{visibleColumns.asset && (
								<th className="text-center py-3 px-4">Asset</th>
							)}
							{visibleColumns.costPerUnit && (
								<th className="text-center py-3 px-4">Cost per Unit</th>
							)}
							...
							{visibleColumns.borrow && (
								<th className="text-center py-3 px-4">Borrow</th>
							)}

							{visibleColumns.quantityForBorrowing && (
								<th className="text-center py-3 px-4">Borrowing Quantity</th>
							)}
