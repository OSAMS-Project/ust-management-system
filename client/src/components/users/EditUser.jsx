  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-75 overflow-y-auto h-full w-full flex items-center justify-center z-10">
      <div className="relative p-8 border w-full max-w-lg shadow-xl rounded-lg bg-white">
        <h3 className="text-xl font-semibold leading-6 text-gray-800 mb-6 border-b pb-4">
          Edit User
        </h3>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                value={user.name}
                readOnly
                className="block w-full px-4 py-2 rounded-lg border border-gray-300 bg-gray-100 text-gray-500 focus:outline-none cursor-not-allowed"
              />
            </div>
            ...
            <div className="flex items-center mt-4">
              <input
                ...
                checked={user.access}
                onChange={(e) =>
                  onChange({ ...user, access: e.target.checked })
                }
