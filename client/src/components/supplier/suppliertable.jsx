        ...
        <tbody>
          {suppliers.map((supplier, index) => (
            <tr 
              ...
              className={`${index % 2 === 0 ? "bg-white" : "bg-[#E8E8E8]"} cursor-pointer hover:bg-gray-50`}
            >
              <td className="py-2 px-4 border-b text-center">{supplier.supplier_id}</td>
              <td className="py-2 px-4 border-b text-center">{supplier.name}</td>
              <td className="py-2 px-4 border-b text-center">{supplier.product}</td>
              <td className="py-2 px-4 border-b text-center">{supplier.streetaddress}</td>
              <td className="py-2 px-4 border-b text-center">{supplier.city}</td>
              <td className="py-2 px-4 border-b text-center">{supplier.contactno}</td>
